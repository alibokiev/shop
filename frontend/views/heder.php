                ...
                <div class="row">
                    ...
                    <div id="header-with-topbar" class="">
                        ...
                        <div id ="basket-container">
                            <div class="bc-b"><a href="<?=!empty($currentUser['login']) ? '/?model=basket&action=view' : '/?model=site&action=login' ?>"><img src="images/bg.png"></a><span><?=sizeof($basketDetails['items'] ?? [])?> items: $<?=$basketDetails['total'] ?? []?></span></div>
                        </div>
                        <div class="mobile-basketc">
                            <div class="m-b"><a href="<?=!empty($currentUser['login']) ? '/?model=basket&action=view' : '/?model=site&action=login' ?>"><img src="images/bg.png"></a></div>
                        </div>
                    </div>
                    <div class="navigator ">
